...
local MUTATION_CONTENTS = {
    ...
    {name = "Frozen", chance = 9.35, color = Color3.fromRGB(100, 150, 255)},
    {name = "Golden", chance = 6.23, color = Color3.fromRGB(150, 0, 200)},
    {name = "Tiny", chance = 6.23, color = Color3.fromRGB(255, 80, 0)},
    {name = "Mega", chance = 6.23, color = Color3.fromRGB(255, 0, 255)},
    {name = "Tranquil", chance = 3.12, color = Color3.fromRGB(0, 0, 0)},
    {name = "IronSkin", chance = 3.12, color = Color3.fromRGB(0, 200, 0)},
    {name = "Radiant", chance = 3.12, color = Color3.fromRGB(0, 200, 255)},
    {name = "Shocked", chance = 3.12, color = Color3.fromRGB(0, 200, 255)},
    {name = "Corrupted", chance = 3.12, color = Color3.fromRGB(0, 200, 255)},
